...
- The assets are 1x and 2x sizes for each image.use them on different screen sizes and resolutions. 
- We've provided an image of the map with the location pin, 
  but you can use the `icon-location.svg` asset if you're doing the bonus challenge.
...
1. Initialize the codebase as a public repository on [GitHub](https://github.com/). 
